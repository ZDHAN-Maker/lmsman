...
<div class="container mx-auto p-4 font-montserrat">
    ...
    <div class="bg-white p-6 rounded-lg shadow-lg">
        <h1 class="text-2xl font-bold mb-6 text-gray-800">Daftar Guru</h1>

        {{-- Import File --}}
        <div class="mb-8 p-4 bg-gray-100 rounded-lg">
            <form action="{{ route('admin.daftar_guru.import') }}" method="POST" enctype="multipart/form-data" class="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
                @csrf
